...
//using PMS.Features.Reservation.Domain.Enums;
//using PMS.Features.Room.Application.DTOS;
//using PMS.Features.Room.Domain.Enums;
...
//                                             r.CheckInDate <= now && r.CheckOutDate > now);
